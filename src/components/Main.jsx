    ...
    ">
      ...
      `}>
        ...
        ">
          <span className="
            text-white
            font-onest not-italic font-bold text-[1.125rem] leading-5.5
          ">
            0xHearts.com
          </span>
          ...
          <span className="
            ...
            text-white/40 font-onest not-italic font-bold text-[0.875rem] leading-4.5
          ">
            Level 43
        ...
        <div className="mx-8 my-auto flex min-w-0 flex-1 justify-center">
          <div className="flex w-full max-w-[43.125rem] flex-col gap-2">
            <div className="h-0.5 w-full bg-[#282828]">
              <div className="h-full w-2/3 bg-[#E8BD70]" />
            </div>

            <div className="flex w-full justify-between">
              <span className="font-onest text-[0.875rem] font-bold text-white/40">
                36,000,000 XP
              </span>
        ...
        ">
          ...
          <span className="
            ...
            font-onest text-[0.75rem] font-bold leading-4.5 tracking-[0.24em]
          ">
            WEEKLY RACE
          </span>
          ...
          <div className="
            ...
            font-onest text-[1.125rem] font-bold leading-6 text-[#c0c1c1]
          ">
            <span>You have</span>
      ...
      ">
        ...
        ">
          <span className="text-white font-onest not-italic font-bold text-[1.75rem] leading-none">Gamemodes</span>

          <span className="text-white/40 font-onest not-italic font-bold text-[0.875rem] leading-4.5">
            Short description bla bla bla bla line word word word word word string word word word word word text insert there!
          </span>
        </div>

        <div className="grid w-full gap-6 grid-cols-[repeat(auto-fit,minmax(17.5rem,1fr))]">
      ...
      <div role="activebattles" className="mt-8">
        <div className="flex items-center">
          <div className="
            flex flex-col items-start gap-2 w-114
          ">
            <span className="text-white font-onest not-italic font-bold text-[1.75rem] leading-none">Active Battles</span>
          ...
          <div className="flex ml-auto gap-2">
            <button className="h-10 py-1.5 px-3.5 bg-[#151515] cursor-pointer">
              <span className="text-[#a1a1a1] font-onest not-italic font-bold text-[0.875rem] leading-[1.125rem]">All battles</span>
            </button>
            ...
            ">
              <span className="text-[#212121] font-onest not-italic font-bold text-[0.875rem] leading-[1.125rem]">Create Battle</span>
            </button>
          </div>
        </div>
        
        {/* COME BACK TO THIS WHEN BATTLES ARE DONE */}
        <div className="mt-6 text-white/70 font-onest not-italic font-bold text-[0.875rem] leading-[1.125rem]">
          <span className="">Rounds</span>
          <span className=" left-[8.625rem]">Boxes</span>
          <span className=" left-[58.3125rem]">Players</span>
          <span className=" left-[81.1875rem]">Actions</span>
        </div>
...
function Gamemodes({ Image, Name }) {
  return (<>
    ...
    `}>
      ...
      ">
        <span className="text-white font-onest not-italic font-bold text-[1.125rem] leading-6">
          {Name}
        </span>
...
function Battles() {
  return(<>
    <div className="
      flex w-full h-[7.125rem] bg-[#151515] mt-4
      grid-cols-[repeat(auto-fit,minmax(17.5rem,1fr))]
      overflow-hidden relative
    ">
      
      <div className="
        relative w-[7.9375rem] flex flex-col items-center justify-center
      ">
        <div className="absolute left-[-2rem] top-[-1.5rem] h-[4.75rem] w-[6rem] shrink-0 rounded-full bg-[#E8BD70] blur-[4.125rem]" />

        <img src="/img/rank.png" className="w-[3.125rem] h-[3.5rem]" />
        <span className="
          text-white font-onest not-italic font-bold text-[1rem] leading-[1.5rem]
          absolute -translate-y-2.75
        ">
          2
        </span>

        <span className="text-white/70 font-onest not-italic font-bold text-[0.875rem] leading-[1.125rem] mt-1.5">Waiting</span>
      </div>

      <div className="h-[7.125rem] w-px opacity-10 bg-[linear-gradient(90deg,#FFFFFF_0%,rgba(255,255,255,0)_100%)] absolute left-[8rem]" />
...
function CaseCarousel() {
  ...
  return(<>
    <div className="relative my-auto flex gap-[0.625rem]">
      <button type="button" aria-label="Previous box" onClick={() => scrollSlider(-1)} className="
        cursor-pointer w-[1.25rem] h-[1.25rem] my-auto shrink-0 ml-[0.625rem]
      ">
...
function Cases({ Colour, Box }) {
  ...
  return(<>
    <button style={{ "--box-colour": boxColour }} className={`group cursor-pointer shrink-0 overflow-hidden relative h-[7.125rem] w-[7.125rem] flex`}>
      <div className="
      ...
      <div className="
        absolute bg-[var(--box-colour)] mix-blend-normal blur-[3rem]
        left-[25.44%] right-[25.44%] top-[85.88%] bottom-[-50%]"
      />

      <div className="
        w-[5rem] h-[5rem] flex my-auto mx-auto relative
        transition-all duration-400 ease-in-out 
